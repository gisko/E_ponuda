...
<div class="row">
		<div class="col-md-4 col-md-offset-4 bg-success">
	      <form class="form-signin" role="form" method="POST" action="./LoginServlet?cont=buyer">
	        <h2 class="form-signin-heading alert alert-info">Buyer log in</h2>
