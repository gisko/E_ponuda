...
<div class="row">
		<div class="col-md-4 col-md-offset-4 bg-success bg-rounded">
	      <form class="form-signin" role="form" method="POST" action="./LoginServlet?cont=admin">
	        <h2 class="form-signin-heading alert alert-info">Administrator log in</h2>
	        ...
	        <input  class="btn btn-lg btn-danger btn-block" type="submit" value="Login"> </input>
	        </br></br>
